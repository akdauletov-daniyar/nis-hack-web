...
const AirQualityModel = () => {
  ...
  const targets = [
    { name: 'C6H6 Concentration', type: 'Regression', color: 'text-blue-500' },
    { name: 'CO Concentration', type: 'Regression', color: 'text-green-500' },
    { name: 'AQI Classification', type: 'Multi-class', color: 'text-orange-500' },
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-6 mb-8">
        ...
        <p className="text-xs text-gray-500 mb-4">Upload a CSV with columns: DATE_OCC, TIME_OCC, Lat, Lon, PT08.S1(CO), Temperature_C, RH% (or RH_%), Wind_Speed, C6H6(GT), AQI</p>
            ...
            <table className="w-full text-sm">
              <thead className="sticky top-0 bg-white dark:bg-gray-900">
                <tr className="border-b border-gray-100 dark:border-gray-800">
                  ...
                  <th className="text-left py-2 px-2 text-gray-500 font-semibold text-xs">CO Concentration</th>
                  <th className="text-left py-2 px-2 text-gray-500 font-semibold text-xs">C6H6 Concentration</th>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-6 mb-8">
        <h2 className="text-lg font-bold text-dark dark:text-white flex items-center gap-2 mb-4">
          <Layers size={20} className="text-primary" /> Architecture
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700">
            <div className="flex items-center gap-2 mb-2">
              <Cpu size={16} className="text-purple-500" />
              <h3 className="font-bold text-dark dark:text-white text-sm">LSTM Encoder</h3>
            </div>
            <p className="text-xs text-gray-500">Multi-layer LSTM captures temporal dependencies across sliding windows of sensor readings, outputting a compact embedding.</p>
          </div>
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700">
            <div className="flex items-center gap-2 mb-2">
              <Zap size={16} className="text-green-500" />
              <h3 className="font-bold text-dark dark:text-white text-sm">Feature Fusion</h3>
            </div>
            <p className="text-xs text-gray-500">LSTM embeddings are concatenated with static/instantaneous features (Lat, Lon, Wind Speed) before passing to ensemble heads.</p>
          </div>
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700">
            <div className="flex items-center gap-2 mb-2">
              <BarChart3 size={16} className="text-orange-500" />
              <h3 className="font-bold text-dark dark:text-white text-sm">Ensemble Heads</h3>
            </div>
            <p className="text-xs text-gray-500">Dual XGBoost + CatBoost heads for regression (C6H6, CO) and classification (AQI). Predictions are averaged for stability.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-6 mb-8">
        <h2 className="text-lg font-bold text-dark dark:text-white flex items-center gap-2 mb-4">
          <Database size={20} className="text-secondary" /> Prediction Targets
        </h2>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-6">
        <h2 className="text-lg font-bold text-dark dark:text-white mb-4">Hyperparameters</h2>
